...
import org.psnbtech.entity.PowerUp;
import org.psnbtech.util.Clock;
import org.psnbtech.entity.Shield;
...
public class Game extends JFrame {
	...
	private Game() {
		...
		addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				...
				case KeyEvent.VK_UP:
					...
					break;
                                ...
                                //Indica cuando queremos rotar el escudo dentro del rango del jugador
			...
			public void keyReleased(KeyEvent e) {
				switch(e.getKeyCode()) {
                                    // Otros casos si se deben manejar eventos de liberación de teclas
	...
	private void updateGame() {
		...
		if(!isGameOver && areEnemiesDead()) {
			...
			this.showLevelCooldown = DISPLAY_LEVEL_LIMIT;
                        setObtainPower(false); // se reinicia el powerup al reiniciar el nivel
  ...
  private boolean obtainPowerUp = false;
  public PowerUp powerup = null;
    
    public void setObtainPower(boolean obtainPowerUp) {
        this.obtainPowerUp = obtainPowerUp;
        if (!obtainPowerUp) {
            if (powerup != null) {
     ...
     public boolean poderActivado() {
        return obtainPowerUp;
    }
